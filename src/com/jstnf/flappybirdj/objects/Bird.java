...
public class Bird extends GameObject
{
	...
	protected final int GRAVITY_SCALE = 1, UPWARD_VELOCITY = -11, WIDTH = (int) (400 * (17.0 / 154.0)), HEIGHT = (int) (
			600 * (12.0 / 256.0)), UPWARD_ROTATION_VELOCITY = 15, ROTATION_LIMIT = 40; // 44 x 28
